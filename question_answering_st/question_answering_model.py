...
from question_answering_st.question_answering_utils import (
...
from question_answering_st.roberta_qa_model import roberta_model
...
class QuestionAnsweringModel:
    def __init__(
        ...
        MODEL_CLASSES = {
            ...
            "roberta": (RobertaConfig, roberta_model, RobertaTokenizer),
        ...
        **kwargs,
        ...
        for _ in train_iterator:
            ...
            for step, batch in enumerate(batch_iterator):
                ...
                # print("\n after _get_inputs_dict !!! inputs !!!")
                # print(inputs)
                if args.fp16:
                    with amp.autocast():
                        # print("train amp model goes here")
                        # print(inputs)
